...
def get_parser():
    ...
    parser.add_argument("--output_dir", type=str, default="../data/SceneFlow/FlyingThings3D_proc")
    parser.add_argument("--data_dir", type=str, default="../data/SceneFlow/FlyingThings3D")
...
if __name__ == '__main__':
    ...
    for imgs, disp, camdata in zip(image_path, diaparity_path, cameradata_path):
        ...
        save_path = os.path.join(args.output_dir, folder[-4], folder[-3], folder[-2], folder[-1])
