...
dataset_metadata = {
    ...
    'scannet': {
        ...
        'mask_path': None,
        'dir_path_func': lambda img_path, seq: os.path.join(img_path, seq, 'color_30'),
        'gt_traj_func': lambda img_path, anno_path, seq: os.path.join(img_path, seq, 'pose_30.txt'),
        'traj_format': 'replica',
        'seq_list': None,
        'full_seq': True,
        'mask_path_seq_func': lambda mask_path, seq: None,
    ...
    'sintel': {
        'img_path': "./data/sintel/training/clean",
